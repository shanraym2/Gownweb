...
export const BODY_DEPTH = {
  hourglass: {
    bust:  0.78,   // ribcage well-defined, moderate depth
    waist: 0.62,   // pronounced lateral compression
    hips:  0.82,   // full hip volume
  },
  pear: {
    bust:  0.72,   // narrower upper body, shallower chest
    waist: 0.58,   // slim waist relative to width
    hips:  0.92,   // deepest hip ratio — posterior projection
  },
  apple: {
    bust:  0.82,   // fuller chest / torso volume
    waist: 0.78,   // midsection carries more depth than other shapes
    hips:  0.80,   // moderate hip depth
  },
  rectangle: {
    bust:  0.74,   // moderate — used as fallback
    waist: 0.68,   // less compressed waist than hourglass/pear
    hips:  0.76,   // proportional to bust
  },
  invertedTriangle: {
    bust:  0.88,   // broadest shoulders, deepest chest
    waist: 0.66,   // narrowing down from chest
    hips:  0.72,   // narrowest hips in the set
  },
  // Aliases for shape IDs that arrive from detectBodyShapeFromPose()
  petite:     { bust: 0.74, waist: 0.66, hips: 0.78 },
  tall:       { bust: 0.74, waist: 0.68, hips: 0.76 },
}
